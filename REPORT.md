...
- **AI Chat**: Interactive Islamic counseling chatbot powered by DeepSeek AI via OpenRouter API
...
- **Networking**: HTTP package for direct Firestore REST API calls and AI API
...
- **Service Layer**: `FirestoreService` and `AIService` provide external integrations
...
- **AI Integration**: OpenRouter for accessing DeepSeek model with Islamic counseling prompt
...
### Future Enhancements
- **AI Improvements**: Enhanced conversation memory and multi-turn context
...
**Project Status**: Core functionality complete with AI integration  
